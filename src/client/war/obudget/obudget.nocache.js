function obudget(){
  ...
  if (!isHostedMode()) {
    try {
      ...
      unflattenKeylistIntoAnswers([$intern_41, $intern_50], $intern_63);
      unflattenKeylistIntoAnswers([$intern_40, $intern_50], $intern_64);
      unflattenKeylistIntoAnswers([$intern_41, $intern_54], $intern_65);
      ...
      unflattenKeylistIntoAnswers([$intern_40, $intern_54], $intern_70);
      unflattenKeylistIntoAnswers([$intern_40, $intern_48], $intern_71);
