function obudget(){
  ...
  if (!isHostedMode()) {
    try {
      unflattenKeylistIntoAnswers([$intern_40, $intern_48], $intern_60);
      ...
      unflattenKeylistIntoAnswers([$intern_41, $intern_55], $intern_65);
