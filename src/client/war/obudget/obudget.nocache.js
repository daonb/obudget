function obudget(){
  ...
  if (!isHostedMode()) {
    try {
      unflattenKeylistIntoAnswers([$intern_41, $intern_52], $intern_60);
      unflattenKeylistIntoAnswers([$intern_40, $intern_54], $intern_61);
      unflattenKeylistIntoAnswers([$intern_41, $intern_50], $intern_62);
      unflattenKeylistIntoAnswers([$intern_41, $intern_48], $intern_63);
      unflattenKeylistIntoAnswers([$intern_41, $intern_55], $intern_64);
      unflattenKeylistIntoAnswers([$intern_40, $intern_48], $intern_65);
      unflattenKeylistIntoAnswers([$intern_41, $intern_54], $intern_66);
      ...
      unflattenKeylistIntoAnswers([$intern_40, $intern_55], $intern_70);
