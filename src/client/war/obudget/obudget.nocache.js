function obudget(){
  ...
  if (!isHostedMode()) {
    try {
      ...
      unflattenKeylistIntoAnswers([$intern_41, $intern_48], $intern_62);
      ...
      unflattenKeylistIntoAnswers([$intern_40, $intern_53], $intern_66);
      ...
      unflattenKeylistIntoAnswers([$intern_41, $intern_50], $intern_70);
