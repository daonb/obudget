function obudget(){
  ...
  if (!isHostedMode()) {
    try {
      unflattenKeylistIntoAnswers([$intern_41, $intern_50], $intern_60);
      unflattenKeylistIntoAnswers([$intern_40, $intern_53], $intern_61);
      ...
      unflattenKeylistIntoAnswers([$intern_41, $intern_48], $intern_67);
