function obudget(){
  ...
  if (!isHostedMode()) {
    try {
      ...
      unflattenKeylistIntoAnswers([$intern_40, $intern_52], $intern_65);
      ...
      unflattenKeylistIntoAnswers([$intern_41, $intern_55], $intern_70);
      unflattenKeylistIntoAnswers([$intern_41, $intern_54], $intern_71);
