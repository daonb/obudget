...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'BudgetLine.title'
        db.alter_column('budget_lines_budgetline', 'title', self.gf('django.db.models.fields.CharField')(max_length=256))


    def backwards(self, orm):
        
        # Changing field 'BudgetLine.title'
        db.alter_column('budget_lines_budgetline', 'title', self.gf('django.db.models.fields.TextField')())
