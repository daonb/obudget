...
class BudgetLine(models.Model):
    ...
    def parent_budget_id(self):
        if self.containing_line == None:
            ...
            return "<a href='/admin/budget_lines/budgetline/?q=%s&year=%s&ot=asc&o=1'>%s</a>" % (self.containing_line.budget_id, self.containing_line.year, self.containing_line.title)
